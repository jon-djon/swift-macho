...
extension FatArchive: Displayable {
    ...
    public var fields: [DisplayableField] {
        [
            .init(
                label: "CPU", stringValue: cpu.description, offset: 0, size: 8,
                children: [
                    .init(
                        label: "Type", stringValue: cpu.type.description, offset: 0, size: 8,
                        children: nil, obj: self),
                    .init(
                        label: "Subtype", stringValue: cpu.subtype.description, offset: 8, size: 8,
                        children: nil, obj: self),
                ], obj: self),
            .init(
            ...
            .init(
                ...
                obj: self),
            .init(
                label: "Align", stringValue: align.description, offset: 16, size: 4, children: nil,
                obj: self),
        ]
    }
