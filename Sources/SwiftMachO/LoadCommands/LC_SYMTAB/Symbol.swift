...
extension Symbol {
        ...
        throws
    {
        ...
        if let sym = DEBUGGER_SYMBOL(rawValue: self.n_desc) {
    ...
    public var fields: [DisplayableField] {
        [
            ...
            .init(
                ...
                children: n_type.activeFlags.enumerated().map { index, flag in
                    .init(
                        label: "0x\(flag.0.rawValue.description)", stringValue: flag.1, offset: 4,
            ...
            .init(
                ...
                children: nil, obj: self),
            .init(
                label: "n_desc", stringValue: n_desc.description, offset: 6, size: 2, children: nil,
                obj: self),
            .init(
