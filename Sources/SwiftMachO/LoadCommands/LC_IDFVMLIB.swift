...
public struct LC_IDFVMLIB: LoadCommand {
    public static let expectedID: LoadCommandHeader.ID = .LC_IDFVMLIB
...
extension LC_IDFVMLIB: Displayable {
    public var description: String { "Fixed VM Shared Library Identification" }
