...
extension LC_MAIN: Displayable {
    ...
    public var fields: [DisplayableField] {
        [
            ...
            .init(label: "Entry Offset", stringValue: entryOff.description, offset: 8, size: 8, children: nil, obj: self),
            .init(label: "Stack Size", stringValue: stackSize.description, offset: 16, size: 8, children: nil, obj: self),
        ]
    }
