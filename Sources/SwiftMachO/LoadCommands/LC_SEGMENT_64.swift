...
public struct VM_PROT: OptionSet, Sendable {
    ...
    public static let VM_PROT_EXECUTE = VM_PROT(rawValue: 0x0000_0004)
    public static let VM_PROT_DEFAULT = VM_PROT(rawValue: 0x0000_0003)
    public static let VM_PROT_RORW_TP = VM_PROT(rawValue: 0x0000_0004)
    ...
    public static let VM_PROT_COPY = VM_PROT(rawValue: 0x0000_0010)
    public static let VM_PROT_WANTS_COPY = VM_PROT(rawValue: 0x0000_0010)
    ...
    public static let VM_PROT_ALLEXEC = VM_PROT(rawValue: 0x0000_0004)
}
    ...
    public var fields: [DisplayableField] {
        [
            ...
            .init(
                ...
                children: nil, obj: self),
            .init(
                label: "Relocations Offset", stringValue: sectionName, offset: 56, size: 4,
                children: nil, obj: self),
            .init(
            ...
            .init(
                ...
                obj: self),
            .init(
                label: "Reserved 1", stringValue: reserved1.description, offset: 8, size: 4,
                children: nil, obj: self),
            .init(
