...
public enum LoadCommandValue {
    ...
    case LC_LINKER_OPTIMIZATION_HINT(LC_LINKER_OPTIMIZATION_HINT, LinkerOptimizationHints)
    ...
    case LC_DYLD_EXPORTS_TRIE(LC_DYLD_EXPORTS_TRIE, ExportTrie)
    ...
    case LC_FUNCTION_VARIANTS(LC_FUNCTION_VARIANTS, FunctionVariants)
    case LC_FUNCTION_VARIANT_FIXUPS(LC_FUNCTION_VARIANT_FIXUPS, FunctionVariantFixups)
