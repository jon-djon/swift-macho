...
public struct LC_LOAD_WEAK_DYLIB: LoadCommand {
    public static let expectedID: LoadCommandHeader.ID = .LC_LOAD_WEAK_DYLIB
...
extension LC_LOAD_WEAK_DYLIB: Displayable {
    public var description: String {
        "The LC_LOAD_WEAK_DYLIB command is to tell the dynamic linker (dyld) which dynamic libraries (dylibs) or frameworks should be attempted to be loaded at the program's startup. If the dylib is not found then the executable will still launch and run."
    }
