...
public struct CodeSignatureBlobWrapper: Parseable {
    ...
    // TODO: Need to break out CMS into it's own library.
...
extension CodeSignatureBlobWrapper {
    ...
    public init(parsing input: inout ParserSpan) throws {
        ...
        guard magic == .BlobWrapper else {
            throw MachOError.badMagicValue(
                "CodeSignatureBlobWrapper unexpected magic value \(self.magic)")
        }
    ...
    public var fields: [DisplayableField] {
        [
            .init(
                ...
                obj: self),
            .init(
                label: "Length", stringValue: length.description, offset: 4, size: 4, children: nil,
                obj: self),
            .init(
                label: "CMS Data Range", stringValue: "\(cmsDataRange.count) bytes", offset: 8,
                size: Int(length), children: nil, obj: self),
        ]
    }
