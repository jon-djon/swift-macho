...
extension LC_SUB_UMBRELLA: Displayable {
    ...
    public var description: String { "The **LC_SUB_UMBRELLA** command identifies a sub-umbrella framework that this framework re-exports. It specifies the name of another umbrella framework whose symbols should be visible to clients linking against this framework. This is part of the two-level namespace mechanism used in macOS frameworks." }
    public var fields: [DisplayableField] {
        [
            ...
            .init(label: "Umbrella Name", stringValue: name, offset: Int(strOffset), size: name.count, children: nil, obj: self),
        ]
    }
