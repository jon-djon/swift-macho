...
public struct LC_LOAD_UPWARD_DYLIB: LoadCommand {
    public static let expectedID: LoadCommandHeader.ID = .LC_LOAD_UPWARD_DYLIB
...
extension LC_LOAD_UPWARD_DYLIB {
...
extension LC_LOAD_UPWARD_DYLIB: Displayable {
    public var description: String {
        "Specifies an upward dependency on a dynamic library — used in umbrella frameworks to reference a sub-library that in turn depends on the umbrella."
    }
